...
##########
#
#  ### Criando listas e inserindo os valores individualmente (vantagem: você insere um nome para cada elemento):
#    balanco2 <- list(ID = seq(101, 104),
#                     nomes = c("Roberta", "Maria", "Marcos", "Felipe"),
#                     Quant = c(12, 10, 22, 12),
...
#  # Resumindo: "nomedalista$nomeexatododoobjeto[indice]" e "nomedalista[[indice]]"
#    balanco4$Histórico
#    balanco2$nomes[2]
#    balanco2$Quant[2]
...
#
#######
#  ## Dando nomes às colunas e às linhas de dentro de uma lista:
#    balanco4$Histórico
#
...
listaInfo <-list(Data="12-10-2020",Gestor="Maurício Almeida", MesReferencia="Outubro")
listaFinal <-c(balanco4,listaInfo)
names(listaFinal)

##Transformando lista em vetor:
unlist(listaFinal)[1]
unlist(listaFinal)[10]

listaFinal$Quantidade[2]
listaNova <-unlist(listaFinal)
